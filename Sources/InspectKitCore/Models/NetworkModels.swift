...
public struct NetworkRequestRecord: Identifiable, Codable, Sendable, Hashable {
    ...
    // Mock tracking — default false/nil so existing call sites need no changes
    public var isMocked: Bool = false
    public var mockRuleName: String? = nil
...
public enum BodyDetection {
    public static func kind(for contentType: String) -> BodyKind {
